...
function PostCard({ post, isFavorite, onToggleFavorite }) {
  const [showComments, setShowComments] = useState(false); //ตัวแปรที่กำหนดว่าจะแสดงความคิดเห็นรึยัง
  ...
  return (
    ...
    >
      ...
      {/* แสดงคอมเม้นก็ต่อเมื่อผู้ใช้กดดูความคิดเห็น - แล้วค่อยไปดึงข้อมูล ณ ตอนนั้น */}
